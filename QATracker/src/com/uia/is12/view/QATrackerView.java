...
public class QATrackerView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("QA Tracker");
        setBounds(new java.awt.Rectangle(400, 200, 700, 500));
        setResizable(false);

        jLabel1.setFont(new java.awt.Font("Arial Black", 1, 18)); // NOI18N
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("BIEVENIDO A QATRACKER");
        ...
        jMenuItem1.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_UP, java.awt.event.InputEvent.CTRL_MASK));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QATrackerView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
